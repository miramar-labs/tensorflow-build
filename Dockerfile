...
# Get TF sources
RUN git clone --depth 1 --branch v2.4.0 git@github.com:tensorflow/tensorflow.git
...
# Install wheel
RUN pip3 install /tmp/tensorflow_pkg/tensorflow-2.4.1-cp36-cp36m-linux_x86_64.whl